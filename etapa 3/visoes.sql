...
2) O nome, o código e a quantidade de cada mercadoria em estoque na empresa.
...
3) O nome do entregador e a quantidade de vezes em que cada caminhão foi usado por ele.
